...
# PYChang, 11.22.2020,Modified code to complete assignment 6
# ---------------------------------------------------------------------------- #
...
class Processor:
    ...
    def read_data_from_file(file_name, list_of_rows):
        ...
        file = open("/Users/pchang/Documents/_PythonClass/Assignment06/ToDoList.txt", "r")
        for line in file:
    ...
    def add_data_to_list(task, priority, list_of_rows):
        ...
        :param priority: (string) priority of the new task:
        :param list_of_rows: (list) list of task:
        :return: (list) of dictionary rows
        """
